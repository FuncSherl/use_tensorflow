...
class SuperSlomo:
    def __init__(self, sess):
        ...
        #训练G的总loss
        self.G_loss_all=204 * self.second_L1_loss_interframe + 102 * self.first_warp_loss + 0.05 * self.second_contex_loss + \
                        tf.clip_by_value(self.second_global_var_loss_all, 0, 30)*0.004
