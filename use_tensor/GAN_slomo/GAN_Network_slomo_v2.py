...
logdir="./logs_v2/GAN_"+TIMESTAMP+('_base_lr-%f_batchsize-%d_maxstep-%d'%(base_lr,batchsize, maxstep))
...
class GAN_Net:
    def __init__(self, sess):
        ...
        self.G_net=(self.Generator_net(frame0and2)+self.frame0)/2.0  #this works error
