...
from data import create_dataset_step3 as cdata
...
class SuperSlomo:
    ...
    def getbatch_train_imgs(self):
        ...
        random_img_width=inimg.shape[2]-self.img_size_w-2
        random_img_height=inimg.shape[1]-self.img_size_h-2
        
        if newstate:
            self.state_random_row_train=np.random.randint(random_img_height)
            self.state_random_col_train=np.random.randint(random_img_width)
